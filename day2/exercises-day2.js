...
var circle = {cx: 34, cy: 43, r: numbers.sort()[numbers.length - 1]};
console.log(circle);
...
var rightTriangle = {base: 33, height: 44};
...
rightTriangle.hyp = Math.sqrt(Math.pow(rightTriangle.base,2) + Math.pow(rightTriangle.height,2));
console.log(shapes);
